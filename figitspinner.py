...
def show_spinner(angle, color, dark_color):
    ...
    pygame.draw.line(display, dark_color,
                     (top[0] + d/2, top[1] + d/2), (centre[0] + d/2, centre[1] + d/2), lw)
    pygame.draw.line(display, dark_color,
                     (left[0] + d/2, left[1] + d/2), (centre[0] + d/2, centre[1] + d/2), lw)
    pygame.draw.line(display, dark_color,
                     (right[0] + d/2, right[1] + d/2), (centre[0] + d/2, centre[1] + d/2), lw)
...
def show_info(friction, speed):
    ...
    speedText = font.render(
        "Rate of Change of Angle : " + str(speed), True, white)
...
def spinner():
    ...
    direction = 1
    color = [[red, dark_red], [blue, dark_blue], [
        yellow, dark_yellow], [green, dark_green], [orange, dark_orange]]
    index = 0
